 ...
 * @author pmeisen
 */
public class TidaStatement extends BaseConnectionWrapper implements Statement, PreparedStatement {
    ...
    public final static class Placeholder {
         ...
         *
         * @param pos the position of the place-holder
         */
         ...
         *
         * @param pos   the position of the place-holder
         * @param value the value of the place-holder
         */
     ...
     *
     * @param connection the connection used to fire the statement
     * @param sql        the statement to be fired
     ...
     * @param connection           the connection used to fire the statement
     * @param sql                  the statement to be fired
     * @param resultSetType        the type of the {@code ResultSet}, supports only
     *                             {@link ResultSet#TYPE_FORWARD_ONLY}
     * @param resultSetConcurrency the concurrency handling, supports only
     *                             {@link ResultSet#CONCUR_READ_ONLY}
     * @param resultSetHoldability the holdability, supports only
     *                             {@link ResultSet#CLOSE_CURSORS_AT_COMMIT} and
     *                             {@link ResultSet#HOLD_CURSORS_OVER_COMMIT}
     * @param columnIndexes        the indexes of the columns to retrieve the key from, should be
     *                             empty or {@code null}
     * @throws SQLException if the statement cannot be created
     */
    public TidaStatement(final TidaConnection connection, final String sql,
     ...
     *                             {@link ResultSet#CLOSE_CURSORS_AT_COMMIT} and
     *                             {@link ResultSet#HOLD_CURSORS_OVER_COMMIT}
     * @param columnNames          the names of the columns to retrieve the key from, should be
     *                             empty or {@code null}
     * @throws SQLException if the statement cannot be created
     */
    public TidaStatement(final TidaConnection connection, final String sql,
     ...
     *                             {@link ResultSet#CLOSE_CURSORS_AT_COMMIT} and
     *                             {@link ResultSet#HOLD_CURSORS_OVER_COMMIT}
     * @param autoGeneratedKeys    the handling of generated keys, supports only
    ...
    public TidaStatement(final TidaConnection connection, final String sql,
                         final int resultSetType, final int resultSetConcurrency,
                         final int resultSetHoldability, final int autoGeneratedKeys) throws SQLException {
        this(connection, sql, resultSetType, resultSetConcurrency,
    ...
    public void close() throws SQLException {
        ...
        if (currentResultSet != null && CurrentResultSetType.USED_BY_STATEMENT.equals(currentResultSetType)) {
     ...
     *
     * @param sql                  the statement to be fired
     * @param type                 the expected type of the {@code TidaResultSet}, can be
     *                             {@link TidaResultSetType#UNKNOWN} if nothing specific is
     *                             expected
     * @param currentResultSetType the type of the usage of the created {@code TidaResultSet}
     * @param autoGeneratedKeys    one of {@link Statement#RETURN_GENERATED_KEYS} or
     *                             {@link Statement#NO_GENERATED_KEYS}
     * @param columnIndexes        the indexes of the columns to retrieve the key from, should be
     *                             empty or {@code null}
     * @param columnNames          the names of the columns to retrieve the key from, should be
     ...
     * @throws SQLException if the {@code Statement} is closed, if the resulting type of
    ...
    protected TidaResultSet execute(final String sql,
        ...
        if (currentResultSet != null && CurrentResultSetType.USED_BY_STATEMENT.equals(this.currentResultSetType)) {
        ...
        final Callable<TidaResultSet> executeTask = () -> new TidaResultSet(TidaStatement.this, query, type,
     ...
     * @param autoGeneratedKeys definition of auto-generated keys should be returned, see
     *                          {@link #TidaStatement(TidaConnection, String, int, int, int, int)}
     *                          for supported settings
     * @param columnIndexes     the column indexes used to retrieve the key, should be empty
     *                          or {@code null}
     * @param columnNames       the column names used to retrieve the key, should be empty or
     *                          {@code null}
     * @return the {@code ResultSet}
     * @throws SQLException if the result cannot be retrieved
     */
    protected TidaResultSet executeQuery(final String sql,
                                         final int autoGeneratedKeys, final int[] columnIndexes,
                                         final String[] columnNames) throws SQLException {
        return execute(sql, TidaResultSetType.QUERY,
     ...
     *
     * @param milliseconds the time-out value to be used
    ...
    public void closeOnCompletion() throws SQLException {
        // nothing to do, we just ignore it so far
    }
     ...
     *
     * @param parameterIndex the index to be checked (1-based)
    ...
    public void setDate(final int parameterIndex, final Date x)
            throws SQLException {
        _setDate(parameterIndex, x, null);
    }
