...
public class TidaStatement extends BaseConnectionWrapper implements Statement,
	...
	private static class RequestResult {
		public final TidaResultSetType type;
		public final TidaResultSet resultSet;
		public final int updateCount;

		public RequestResult(final TidaResultSetType type,
				final TidaResultSet resultSet, final int updateCount) {
			this.type = type;
	...
	protected RequestResult execute(final String sql,
		...
		final TidaResultSet rs = new TidaResultSet(this, query, type,
		...
		if (rs.isResultSetType(TidaResultSetType.MODIFY)) {
			res = new RequestResult(rs.getResultSetType(), null, 0);

			// the resultSet itself is not needed anymore
			rs.close();
		} else {
			res = new RequestResult(rs.getResultSetType(), rs, -1);
		}
	...
	public boolean execute(final String sql) throws SQLException {
		final RequestResult res = execute(sql, TidaResultSetType.UNKNOWN,
				Statement.NO_GENERATED_KEYS, null, null);

		return res.resultSet != null;
	}
