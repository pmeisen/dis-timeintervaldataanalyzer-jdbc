 ...
 * @author pmeisen
 */
public class TidaDatabaseMetaData extends BaseWrapper implements DatabaseMetaData {
     ...
     * {@code connection}.
     *
     * @param connection the {@code TidaConnection} to retrieve the meta-data for
     */
    ...
    public ResultSet getPseudoColumns(final String catalog,
                                      ...
                                      final String columnNamePattern) throws SQLException {
        return new EmptyResultSet(new String[]{"TABLE_CAT", "TABLE_SCHEM",
                "TABLE_NAME", "COLUMN_NAME", "DATA_TYPE", "COLUMN_SIZE", "DECIMAL_DIGITS",
                "NUM_PREC_RADIX", "COLUMN_USAGE", "REMARKS", "CHAR_OCTET_LENGTH",
                "IS_NULLABLE"});
    }
