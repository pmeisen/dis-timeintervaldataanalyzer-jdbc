...
public class ObjectArrayResultSet extends BaseWrapper implements ResultSet {
     ...
     * @param filterPattern the {@code LIKE} expression to filter the rows
     */
    public ObjectArrayResultSet(final String[] labels, final Object[][] data,
     ...
     * @param labels         the labels of the columns
     * @param data           the rows
     * @param filterPatterns a {@code Collection} of patterns specifying the columns and
    ...
    public ObjectArrayResultSet(final String[] labels, final Object[][] data,
        ...
        if (filterPatterns == null) {
            ...
            final List<Object[]> filteredData = new ArrayList<>();
            final Map<String, String> regEx = new HashMap<>();
            ...
            for (final Object[] row : data) {
                ...
                for (final Entry<String, String> e : regEx.entrySet()) {
                    ...
                    addRow = val != null && val.toString().matches(e.getValue());
     ...
     * {@code Stra%e} matches Strasse, Straße, Strae, etc.</li>
     * <li>{@code _} - means any character exactly one time, e.g. {@code Stra_e}
     * matches Straße, Strafe, etc. Strasse does not match {@code Stra_e}!</li>
     * </ul>
     ...
     * </ul>
     *
     * @param pattern the {@code LIKE}-statement to be transformed
     ...
     *
     * @param names the array to search in
     * @param label the value to be found
     ...
     * @throws SQLException if the current position is invalid
     */
    ...
    private <T> T getCurrentValue(final int columnIndex,
                                  final Class<T> type,
    ...
    public byte getByte(final int columnIndex) throws SQLException {
        ...
        return getCurrentValue(columnIndex, Byte.class, false);
    }
    ...
    public short getShort(final int columnIndex) throws SQLException {
        ...
        return getCurrentValue(columnIndex, Short.class, false);
    }
    ...
    public <T> T getObject(final int columnIndex, final Class<T> type) throws SQLException {
        ...
        return getCurrentValue(columnIndex, type, true);
    }
