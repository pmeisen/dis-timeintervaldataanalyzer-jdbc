...
public class IntResultSet extends BaseWrapper implements ResultSet {
     ...
     *
     * @param ints      the integers to create the {@code ResultSet} for
     * @param statement the statement creating the {@code ResultSet}
     */
    ...
    public <T> T getObject(final int columnIndex, final Class<T> type) throws SQLException {
        ...
        return transformNumber(getCurrentValue(), type);
    }
    ...
    private <T> T transformNumber(final Object value, final Class<T> anyType) throws SQLException {
        final Class<?> type;

        if (anyType.isPrimitive()) {
            if (byte.class.equals(anyType)) {
                type = Byte.class;
            } else if (short.class.equals(anyType)) {
                type = Short.class;
            } else if (int.class.equals(anyType)) {
                type = Integer.class;
            } else if (long.class.equals(anyType)) {
                type = Long.class;
            } else if (double.class.equals(anyType)) {
                type = Double.class;
            } else if (float.class.equals(anyType)) {
                type = Float.class;
            } else {
                throw new IllegalArgumentException("Unsupported type: " + anyType);
            }
        } else {
            type = anyType;
        }
        ...
        if (Number.class.isInstance(value)) {
            ...
            if (Byte.class.equals(type)) {
                ...
                return (T) new BigDecimal(Number.class.cast(value).toString());
            } else if (BigInteger.class.equals(type)) {
                return (T) new BigInteger(Number.class.cast(value).toString());
            ...
            final String strValue = String.class.cast(value);
            ...
            if (Byte.class.equals(type)) {
                ...
                return (T) new AtomicInteger(Integer.valueOf(strValue));
            } else if (AtomicLong.class.equals(type)) {
                return (T) new AtomicLong(Long.valueOf(strValue));
            } else {
